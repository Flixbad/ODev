...
<head>
  ...
  <title>Installation — ODev Gestion</title>
...
<body class="auth-body">
  <main class="auth-card">
    ...
    <h1>Installation</h1>
    <p class="muted">Connectez MySQL Hostinger (phpMyAdmin) et créez votre compte admin.</p>
    ...
    <?php if ($success): ?>
      ...
      <p><a class="btn btn-primary" href="index.php?r=login">Se connecter</a></p>
    <?php elseif ($done): ?>
      <div class="flash flash-success">Déjà installé.</div>
      <p><a class="btn btn-primary" href="index.php?r=login">Se connecter</a></p>
    <?php else: ?>
      <form method="post" class="stack">
        ...
        <h2 class="h-section">Compte admin</h2>
